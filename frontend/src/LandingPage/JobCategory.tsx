...
const JobCategory = () => {
    ...
    <div className="text-4xl text-center font-semibold mb-3 text-mine-shaft-100">
        Посмотрите <span className="text-bright-sun-400">вакансии</span> по категориям</div>
        <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w=1/2">
            Подберите вакансию, соответствующую вашим навыкам. Начните свой карьерный путь уже сегодня!</div>
            ...
            previousControlIcon={<IconArrowLeft className="h-8 w-8" />}>
                {
                    jobCategory.map((category, index) => <Carousel.Slide>
                        <div className="flex flex-col items-center w-64 gap-2 border border-bright-sun-400 p-5
                         rounded-xl hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] my-5 transition duration-300 ease-in-out !shadow-bright-sun-300">
