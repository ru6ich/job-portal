...
const CertiCard = (props:any) => {
    ...
    const handleDelete=()=>{
        ...
        successNotification("Успешно", "Сертификат успешно удален");
    }
    return <div className="flex justify-between">
        ...
        <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col items-end">
                ...
                {props.edit&&<ActionIcon onClick={handleDelete} size="lg" color="red.8" variant="subtle" aria-label="Settings">
